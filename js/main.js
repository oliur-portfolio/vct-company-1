...
const teamBtn = document.querySelector(".team-collapse-area button.active");

const removeBtn = document.querySelector(".team-collapse-area button");
